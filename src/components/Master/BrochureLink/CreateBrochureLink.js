...
const CreateBrochureLink = ({ onClose, handleDataChange }) => {
          ...
          >
            {({ values, setFieldValue, errors, touched }) => (
              <Form style={{ width: "100%" }}>
                ...
                <div style={{ marginBottom: "24px" }}>
                  <label htmlFor="name">
                    Brochure Link <span style={{ color: "red" }}>*</span>
                  </label>
                  <Field
                    name="name"
                    type="text"
...
export default CreateBrochureLink;
